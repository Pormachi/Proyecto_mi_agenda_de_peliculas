...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print("La pelicula más larga es: " + str(pelicula_mas_larga["nombre"])+ ", la cual tiene una duración de "+ str(pelicula_mas_larga["duracion"])+ " minutos.")
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio= int(input("Ingrese el año limite de estreno: "))
    peliculas = mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio)
    
    print ("Las peliculas de estreno según el año especificado son: "+ str(peliculas))
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict) -> None:
    ...
    print("Existen "+str(cantidad)+" peliculas que tienen clasificación 18+.")
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    nuevo_dia = input("Ingrese el nuevo dia en el cual se quiere ver la pelicula: ")
    nueva_hora = int(input("ingrese la nueva hora a la cual se quiere ver la pelicula: "))
    control_horario = bool(input("¿Desea controlar el horario de las peliculas? Si la respuesta es afirmativa, ingrese el valor \"True\" de lo contrario ingrese \"False\": "))
    
    reagendamiento = bool(mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5))
        
    if pelicula is None:
        print("No hay ninguna pelicula con este nombre")
    
    
    elif reagendamiento == True:
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    autorizacion_padres = input("¿El invitado cuenta con la autorizacion de sus padres para ver la pelicula? Si la respuesta es afirmativa, ingrese el valor \"True\" de lo contrario ingrese \"False\": ")
    ...
    if pelicula is None:
        ...
        print("Se puede invitar a esta persona a ver la pelicula")        
    else:
        print("No se puede invitar a esta persona a ver la pelicula")
